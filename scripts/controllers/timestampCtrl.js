angular.module('vidyKb')
	.controller('timestampCtrl', function($scope) {
		...
		// 		html = html + " <button id=\"" + phraseId + "_playButton\"onclick=\"javascript:did_tap_play_button(" + i + "); return false;\">play</button> <button onclick=\"javascript:did_tap_delete_button(" + i +
		// 			"); return false;\">delete</button><br>";
		// 	}
